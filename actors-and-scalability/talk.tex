...
% Metadata
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[Aktoren und die Cloud]{Aktoren und die Cloud}
%\subtitle{}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{itemize}
    \item Bis April -- wiss. Mitarbeiter
...
\begin{frame}
  ...
  \begin{itemize}
  \item Entwicklung eines Übersetzers inkl.\  Laufzeitumgebung
  ...
  \item Motivation: Datenfluss-Semantik $\approx$ Aktorenmodell
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Ein Aktor pro Operator
  \item Jeder Aktor kennt seine Kind- und Elternknoten
  \item Eingabe: AST des Datenfluss-Programms
  \item Start: ein IO-Aktor der mit dem User interagiert
    \begin{itemize}
  ...
  \item Evaluierung: Demand-Driven
    \begin{itemize}
    \item IO-Knoten generiert Sequenz von Anfragen and den obersten Ausdrucksknoten für $t_0, t_1, t_2, \ldots$
    \end{itemize}
  \item Aktornetzwerk wird bei Bedarf dynamisch aufgebaut
...
\begin{frame}
  \begin{center}
    \begin{Large}
      \hl{-- Aktoren heute und die Cloud --}
    \end{Large}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Wo stehen wir heute?}
  \begin{itemize}
  \item \structure{Big Data:} Map-Reduce, Hadoop, Kafka, Spark (im Prinzip FP)
  \item \structure{Cloud Deployment:} Docker, Kubernetes, Helm, REST Nachrichten sind primäre Kommunikation
  \end{itemize}
  \begin{center}
...
\begin{frame}
  ...
  \item Micro-Service Design am Beispiel der Indizierung:
    \begin{itemize}
    \item Mehrere Services, mit quer verschalteten Aktorensystemen
...
\begin{frame}
  ...
  \begin{itemize}
  \item Ein Aktor je Besucher, ein Aktor je Scanner
  \item Jeder Besucher-Aktor enthält seinen internen Zustand
...
\begin{frame}
  ...
  \begin{itemize}
  \item Aktoren liefern ein ideales Modell für nebenläufige Prozesse
